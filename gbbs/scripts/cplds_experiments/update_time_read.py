...
def main():
  ...
  with open('update_time.txt') as parameters_file:
  ...
  for program in programs:
    ...
    #sub.wait()
  print("Program, File Name, Num Upates, Num Update Threads, Num Read Threads, Avg Update Time (sec), Max Update Time (sec)", end="\n")
