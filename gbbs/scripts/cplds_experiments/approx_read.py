...
def main():
  ...
  with open('approx.txt') as parameters_file:
  ...
  for program in programs:
    ...
    #sub.wait()
  print("Program, File Name, Num Upates, Num Update Threads, Num Read Threads, Avg Approx Factor, Max Approx Factor", end="\n")
              ...
              for nw in num_workers:
                  for nt in num_reader_threads:
                      for percent in percentiles:
                        ...
                        if program_pres[program_idx] == "SyncReads":
                            print(best_avg_error, end=", ")
                            print(best_max_error, end="\n")
                        else:
